...
lyr_OSMStandard_0.setVisible(true);lyr_GoogleSatellite_1.setVisible(true);lyr_amphoe_2.setVisible(true);lyr_water_way_3.setVisible(true);lyr_village_4.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_GoogleSatellite_1,lyr_amphoe_2,lyr_water_way_3,lyr_village_4];
